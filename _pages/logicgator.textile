...
fig(noshadow). http://jakemadethis.com/logicgator/screenshot1.png

fig(noshadow). http://jakemadethis.com/logicgator/screenshot2.png

fig(noshadow). http://jakemadethis.com/logicgator/screenshot3.png

fig(noshadow). http://jakemadethis.com/logicgator/screenshot4.png